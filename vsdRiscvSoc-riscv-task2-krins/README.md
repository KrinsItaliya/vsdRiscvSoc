...
static void uniq_print_header(const char *program_name) {
    ...
    char buf[512];
    snprintf(buf, sizeof(buf), "%s|%s|%s|%s|%ld|%s|%s",
...
![output_facrorial](https://github.com/user-attachments/assets/c2ea0d59-e9a2-49bd-842f-b940bb090008)

## TASK-2.8.1 - max_array
![output_max_array](https://github.com/user-attachments/assets/237c2205-4ce6-4979-98fe-f0cc47dfa517)

## TASK-2.8.1 - bitops
![output_bitops](https://github.com/user-attachments/assets/fceacb6f-db8f-4b5e-961b-96e77866b61b)

## TASK-2.8.4 - bubble_sort
![output_bubble_sort](https://github.com/user-attachments/assets/40fe344d-c357-48b4-b132-cfc15ada73dc)
...
![output_spike_version](https://github.com/user-attachments/assets/369d53e0-30f0-4acf-b53c-2c2832616c22)

## TASK-2.10.2 - verifying gcc version
![output_gcc_version](https://github.com/user-attachments/assets/31de6c60-2d6c-49d8-9b1c-2ddfe19be51c)
